...
function ShareSuite() {
  ...
  if (!selectedRequest && requests.length === 0) {
    return (
      <div className="max-w-lg mx-auto px-4 py-16 text-center bg-white rounded-3xl border border-gray-100 shadow-sm mt-8">
        <div className="text-5xl mb-4">🩸</div>
        <h3 className="text-xl font-bold text-gray-900 mb-2">No urgent requests to share</h3>
        ...
        <Link
          ...
          className="bg-red-600 hover:bg-red-700 text-white font-semibold px-6 py-2.5 rounded-xl transition shadow-sm text-sm"
        >
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8 animate-fadeIn">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4 mb-8">
        ...
        {requests.length > 1 && (
          <div className="bg-white border border-gray-200 rounded-xl p-1.5 shadow-sm flex items-center gap-2">
            <span className="text-xs font-semibold text-gray-500 pl-2">Select Request:</span>
            <select
              value={req._id}
              onChange={(e) => {
              ...
              className="bg-gray-50 border border-gray-300 text-gray-800 text-xs rounded-lg px-2.5 py-1.5 font-semibold focus:outline-none focus:ring-2 focus:ring-red-500"
            >
              {requests.map((item) => (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 bg-white rounded-3xl border border-gray-100 p-8 shadow-sm relative overflow-hidden group">
          {/* Subtle Graphic Accents */}
          <div className="absolute -top-16 -right-16 w-40 h-40 bg-red-50 rounded-full blur-2xl opacity-60 pointer-events-none" />
          <div className="absolute -bottom-16 -left-16 w-40 h-40 bg-yellow-50 rounded-full blur-2xl opacity-60 pointer-events-none" />
          ...
          <div className="space-y-6 relative z-10">
            <div className="flex flex-wrap items-center justify-between gap-4 pb-6 border-b border-gray-100">
              <div>
                <span className="text-xs font-semibold text-gray-400 uppercase tracking-wider block mb-1">Patient Name</span>
                <h3 className="text-3xl font-extrabold text-gray-900 tracking-tight">{req.patientName}</h3>
              </div>
              <div className="flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
              <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100/80">
                ...
                <p className="text-base font-bold text-gray-900 mt-1">{req.hospital}</p>
              </div>
              ...
              <div className="bg-gray-50 rounded-2xl p-4 border border-gray-100/80">
                ...
                <p className="text-base font-bold text-gray-900 mt-1">{req.city}</p>
              </div>
            </div>

            <div className="bg-red-50/70 border border-red-200/80 rounded-2xl p-6 text-center mt-6">
              <span className="text-xs font-bold text-red-800 uppercase tracking-wider flex items-center justify-center gap-1.5 mb-1">
                <Phone className="w-3.5 h-3.5 text-red-600" />
                <span>Family Contact Phone</span>
              </span>
              <a href={`tel:${req.contactPhone}`} className="text-3xl font-black text-red-600 hover:underline tracking-tight block mt-1">
                {req.contactPhone}
              </a>
              <span className="text-xs text-red-600/80 font-medium mt-2 block">Tap to call family directly</span>
            </div>
          </div>
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm space-y-4">
            ...
            <div className="space-y-3 mt-6 pt-2">
              ...
              <button
                ...
                className="w-full bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold py-3.5 px-5 rounded-2xl transition flex items-center justify-center gap-2.5 shadow-sm text-sm"
              >
              ...
              <a
                ...
                className="w-full bg-black hover:bg-gray-800 text-white font-semibold py-3.5 px-5 rounded-2xl transition flex items-center justify-center gap-2.5 shadow-sm text-sm"
              >
              ...
              <button
                ...
                className="w-full border-2 border-gray-300 hover:bg-gray-50 text-gray-800 font-semibold py-3.5 px-5 rounded-2xl transition flex items-center justify-center gap-2.5 text-sm"
              >
          ...
          <div className="bg-white rounded-3xl border border-gray-100 p-8 shadow-sm">
            <h4 className="text-sm font-bold text-gray-900 mb-2">Direct Public Link</h4>
            <div className="flex items-center gap-2">
              <input
                type="text"
                readOnly
                value={shareUrl}
                className="bg-gray-50 border border-gray-200 text-gray-600 text-xs rounded-xl px-3.5 py-3 w-full font-mono focus:outline-none"
              />
              <button
                type="button"
                onClick={handleCopyLink}
                className="bg-gray-100 hover:bg-red-600 hover:text-white text-gray-700 font-semibold px-4 py-3 rounded-xl transition flex items-center gap-1.5 shrink-0 text-xs"
              >
          ...
          <div className="bg-red-50/80 border border-red-200/80 rounded-3xl p-6 text-center">
            <span className="text-2xl block mb-2">🤝</span>
            <h4 className="text-sm font-bold text-red-900">Are you a blood donor?</h4>
            ...
            <Link
              ...
              className="inline-block mt-4 text-xs font-bold bg-white text-red-700 hover:bg-red-100 border border-red-200 px-4 py-2 rounded-xl transition shadow-sm"
            >
