      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-855 rounded-2xl p-4 flex flex-wrap gap-3 items-center shadow-2xs">
        ...
        <div className="flex flex-wrap gap-3 items-center">
          ...
          >
            ...
            <option value="available" className="bg-white dark:bg-slate-950">Active / Available</option>
            <option value="unavailable" className="bg-white dark:bg-slate-950">Inactive / Unavailable</option>
          </select>
          <select 
